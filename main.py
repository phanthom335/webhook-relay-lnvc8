    ...
    Webhook Relay Lnvc8
    ===================
    Open-source API service that routes data between clients and backends.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source API service that routes data between clients and backends.")
